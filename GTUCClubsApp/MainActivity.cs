...
namespace GTUCClubsApp
{
    ...
    {
        UserProfileListener UserProfle = new UserProfileListener();
        FirebaseAuth auth;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (IsUserLogedIn != null)
            {
                ...
                UserProfle.UserCreate();
                //string NotificationContent = Intent.Extras.GetString("Title");
            }
            else
            {
        ...
        void LoadFragment(int id)
        {
            ...
            switch (id)
            {
                ...
                case Resource.Id.nav_search:
                    fragment = AnnouncementSearch.NewInstance();
                    break;
